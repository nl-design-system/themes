# @nl-design-system-unstable/purmerend-design-tokens
...
- c5299b0: Use new standard design tokens package filenames:
  ...
  - `_mixin.scss`: SCSS file with a mixin that adds all CSS variables `@mixin purmerend-theme { /* ... */ }`.
...
- 3273fdc: Overview of tokens that had the utrecht prefix and now have the purmerend prefix:
