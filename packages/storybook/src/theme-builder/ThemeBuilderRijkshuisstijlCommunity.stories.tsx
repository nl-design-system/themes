...
import { theme as rijkshuisstijlCommunityTheme } from './rhcTheme.mjs';
import rotterdamTheme from '@gemeente-rotterdam/design-tokens/dist/tokens.cjs';
import { ThemeBuilder } from './ThemeBuilder';
import { examples } from './examples';

const meta = {
  title: 'Theme Builder/Rijkshuisstijl Community',
  id: 'theme-builder-rhc',
  component: ThemeBuilder,
  args: {
    step: 0,
    steps,
    basis: basisTheme,
    theme: rijkshuisstijlCommunityTheme,
    themeExtension: {
      basis: {
        common: {
          typography: {
