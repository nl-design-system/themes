...
import rijkshuisstijlCommunityTheme from '@rijkshuisstijl-community/design-tokens/dist/tokens.js';
import rotterdamTheme from '@gemeente-rotterdam/design-tokens/dist/tokens.cjs';
import { ThemeBuilder } from './ThemeBuilder';
import { examples } from './examples';
import amsterdamValueTree from '@amsterdam/design-system-tokens/dist/index.json';
import {
  convertValueTreeToDesignTokenTree,
  DesignTokenTree,
} from '@nl-design-system-unstable/theme-toolkit/dist/design-tokens';
import { addPath } from '@nl-design-system-unstable/theme-toolkit/dist/ExampleTokensCSS';

export const amsterdamTheme = addPath(convertValueTreeToDesignTokenTree(amsterdamValueTree)) as DesignTokenTree;
...
const meta = {
  ...
  argTypes: {
    ...
    theme: {
      control: 'select',
      options: ['voorbeeld', 'groningen', 'denhaag', 'rotterdam', 'utrecht', 'rijkshuisstijl-community'],
      mapping: {
        ...
        rijkshuisstijlCommunity: rijkshuisstijlCommunityTheme,
      },
    },
  },
