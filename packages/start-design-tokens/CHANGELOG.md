...
- 59e7bee: De volgende tokens zijn toegevoegd aan grid component:
...
- e27f720: De volgende tokens zijn toegevoegd aan Root component:
  ...
  Root, Page Body en Document tokenset binnen JSON op juiste positie.
