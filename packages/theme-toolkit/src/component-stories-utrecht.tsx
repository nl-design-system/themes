...
export const UTRECHT_COMPONENT_STORIES: ComponentStory[] = [
  ...
  {
    storyId: 'react-utrecht-form-field-label--default',
    group: STORY_GROUPS['FORM_FIELD_LABEL_DEFAULT'],
    name: 'Utrecht Form Field Label',
    render: () => <FormFieldLabel>Label for form control</FormFieldLabel>,
    detectTokens: {
      anyOf: ['utrecht.form-label.color', 'utrecht.form-label.font-weight', 'utrecht.form-label.font-size'],
    },
  },
  {
    storyId: 'react-utrecht-form-field-label--disabled',
    group: STORY_GROUPS['FORM_FIELD_LABEL_DEFAULT'],
    name: 'Utrecht Form Field Label: Disabled',
    state: true,
    render: () => <FormFieldLabel disabled>Label for disabled form control</FormFieldLabel>,
    detectTokens: {
      anyOf: ['utrecht.form-label.disabled.color'],
    },
  },
  {
    storyId: 'react-utrecht-form-field-label--checkbox',
    group: STORY_GROUPS['FORM_FIELD_LABEL_CHECKBOX'],
    name: ' Utrecht Checkbox Form Field Label',
    render: () => <FormFieldLabel type="checkbox">Label for checkbox option</FormFieldLabel>,
    detectTokens: {
      anyOf: ['utrecht.form-label.checkbox.font-weight'],
    },
  },
  {
    storyId: 'react-utrecht-form-field-label--checkbox-checked',
    group: STORY_GROUPS['FORM_FIELD_LABEL_CHECKBOX'],
    name: 'Utrecht Checkbox Form Field Label: Checked',
    state: true,
    render: () => <FormFieldLabel checked>Label for checked checkbox option</FormFieldLabel>,
    detectTokens: {
      anyOf: ['utrecht.form-label.checked.color', 'utrecht.form-label.checked.font-weight'],
    },
  },
  {
    storyId: 'react-utrecht-form-field-label--radio',
    group: STORY_GROUPS['FORM_FIELD_LABEL_RADIO'],
    name: 'Utrecht Radio Button Form Field Label',
    render: () => <FormFieldLabel type="radio">Label for radio button option</FormFieldLabel>,
    detectTokens: {
      anyOf: ['utrecht.form-label.radio.color', 'utrecht.form-label.radio.font-weight'],
    },
  },
  {
    storyId: 'react-utrecht-form-field-label--radio-checked',
    group: STORY_GROUPS['FORM_FIELD_LABEL_RADIO'],
    name: 'Utrecht Radio Button Form Field Label: Checked',
    state: true,
    render: () => <FormFieldLabel checked>Label for selected radio button option</FormFieldLabel>,
  },
  {
