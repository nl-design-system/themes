...
export const UTRECHT_COMPONENT_STORIES: ComponentStory[] = [
  ...
  {
    storyId: 'react-utrecht-alert--content',
    component: 'utrecht-alert',
    name: 'Utrecht Alert content',
    render: () => (
      <Alert type="content">
        <Heading1>Lorem ipsum</Heading1>
        <Paragraph>
    ...
    detectTokens: {
      anyOf: ['utrecht.alert.content.row-gap'],
    },
  },
  {
  ...
  {
    storyId: 'react-utrecht-alert--icon',
    component: 'utrecht-alert',
    name: 'Utrecht Alert icon',
    render: () => (
      <Alert type="icon">
        <Heading1>Lorem ipsum</Heading1>
        <Paragraph>
